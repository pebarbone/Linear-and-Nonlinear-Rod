...
\centering
%%\vspace{-5mm}		% some adjustment up or down is possible.
	\includegraphics[width= 9cm]{self-weight-buckling-load.png}
	\caption{This is a random figure placed for Andre.}
\end{wrapfigure}
